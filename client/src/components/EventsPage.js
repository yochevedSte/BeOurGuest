...
class EventsPage extends Component {
    ...
    handleEvent = (index) => {
        ...
        this.setState({ pageRender: false });
        this.props.history.push("/" + this.props.store.user._Id + "/event/" 
            ...
            (
                <div className={classes.backgroundImg}>
                    <div className="container">
                        <div className="row">
                            <h3 className={classes.mainText}>Select an event or create a new one</h3>
                        </div>
                        <div className="row">
...
export default withRouter(withStyles(styles)(EventsPage));
